...
# Introduction
**Turn your Android phone into real Amateur Radio VHF/UHF APRS enabled Codec2 DV (digital voice) handheld transceiver. Requires additional digital radio hardware or software (e.g. Direwolf) modem**
