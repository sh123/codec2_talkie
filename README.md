...
- **TCP/IP connectivity** on startup, application can coonnect to TCP/IP based modem and operate through the network, for example, with Direwolf application over KISS
