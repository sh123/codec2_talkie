...
- **PTT hardware button**, `KEYCODE_HEADSETHOOK` and `KEYCODE_TV_DATA SERVICE` (230 key code) hardware buttons are used for PTT (latter used on some Android network radios)
