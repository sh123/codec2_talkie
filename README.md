...
- USB serial connectivity at 115200 bps, 8 data bits, 1 stop bit and none parity, just select this app after connecting to USB and it will use given connection
